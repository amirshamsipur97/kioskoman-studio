...
export function SelectedWork() {
  return (
    <section id="work" className="relative w-full px-6 py-28 sm:py-36 bg-[#101010] text-[#f7f5ef]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {WORKS.map((w, i) => (
            ...
            >
              <Link
                href={`/work/${w.slug}`}
                className="group block rounded-2xl bg-white/[0.04] ring-1 ring-white/10 overflow-hidden"
              >
                ...
                <div className="px-5 py-4 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-[12.5px] text-white/55 mt-0.5">{w.tag}</div>
                  </div>
